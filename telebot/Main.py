...
# # Thay đổi timeout khi gọi application.run_polling()
# async def main():
#     try:
#         await application.run_polling(timeout=60)  # timeout được thiết lập là 60 giây (hoặc bất kỳ giá trị nào phù hợp)
...
#     # Chạy hàm main trong event loop asyncio
